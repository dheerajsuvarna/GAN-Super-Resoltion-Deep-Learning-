...
if __name__ == '__main__':
    ...
    discriminator = DiscriminatorPretrained(imgSize=opt.imageSize*opt.upSampling)
    ...
    # Set starting point for srgan testing
    srgan_test_start_time = time.time()
    ...
    # End srgan testing
    srgan_test_time = time.time() - srgan_test_start_time
    print("Total time taken for testing:.... ", srgan_test_time)
u